...
function banner(){
    ...
    echo -e " ████████▀  █▀    ▀█   ███   █▀   ▀██████▀  ████████▀     #"
    echo -e "###########################################################"
    echo -e "AUTHOR     : D1MO1877                                     #"
    echo -e "WEBSITE    : https://d1mdev.ml                            #"
    echo -e "BLACK SHOP : https://d1modshop.ml                         #"
    echo -e "DISCORD    : https://discord.gg/hn7epsef4Z                #"
    echo -e "1877       : https://1877.team                            #"
    echo -e "###########################################################"
